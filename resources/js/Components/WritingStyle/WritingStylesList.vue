        ...
        <thead class="text-xs text-gray-700 bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
          <tr>
            ...
            <th scope="col" class="px-6 py-3 text-right">
              <Button :href="route('styles.create')" as="a" variant="primary" class="text-sm">
        ...
        <tbody>
          <tr v-for="writingStyle in writingStyleStore.writingStyles" :key="writingStyle.id" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
            <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
              <p>{{ writingStyle.data.title }}</p>
              <p class="text-xs">Erstellt am {{writingStyle.created_at}}</p>
            </th>
            <td class="px-6 py-4 text-right">
              <div class="inline-flex rounded-md shadow-sm" role="group">
                <a :href="route('styles.show', writingStyle.data.id)" type="button" class="inline-flex items-center px-4 py-2 text-sm font-medium text-blueGray bg-white border border-gray-200 rounded-l-lg hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-blue-500 dark:focus:text-white">
                ...
                <button type="button" @click="writingStyleStore.delete(writingStyle)" class="inline-flex items-center px-4 py-2 text-sm font-medium text-blueGray bg-white border-t border-b border-r rounded-r-lg border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-blue-500 dark:focus:text-white">
